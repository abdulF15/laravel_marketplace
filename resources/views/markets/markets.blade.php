...
<div id="alert-border-1" class="mt-3 flex items-center p-4 mb-4 text-blue-800 border-t-4 border-blue-300 bg-blue-50 dark:text-blue-400 dark:bg-gray-800 dark:border-blue-800" role="alert">
            ...
            @if (session('cart'))
                @foreach (session('cart') as $id => $details)
                    ...
                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <button class="cart_remove font-medium text-blue-600 dark:text-blue-500 hover:underline"><i data-feather="trash"></i></button>
                        </td>
                    </tr>
                @endforeach   
            @endif
