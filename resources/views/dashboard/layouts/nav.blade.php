        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="/home" class="flex ml-2 md:mr-24">
                    <img src="{{ asset('img/tokped.png') }}" class="h-8 mr-3" alt="tokoijo" />
                    <span class="self-center text-xl text-green-500 font-semibold sm:text-2xl whitespace-nowrap dark:text-white">TokoIjo</span>
                </a>
                ...
                <div class="flex items-center ml-3">
                    <div>
                        <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                            ...
                            <img class="w-10 h-10 rounded-full border-2 border-slate-500" src="{{ asset('img/profile.jpg') }}" alt="user photo">
                        </button>
                    </div>
